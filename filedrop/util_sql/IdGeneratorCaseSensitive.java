...
public class IdGeneratorCaseSensitive {
	
	//< value, id >
	public HashMap<String, Integer> existingIds=new HashMap<String, Integer>();
	public HashMap<String, Integer> newIds=new HashMap<String, Integer>();
	...
	public IdGeneratorCaseSensitive(Connection in_con, String in_idTableName) throws Exception{
		con=in_con;
	...
	public IdGeneratorCaseSensitive(Connection in_con, String in_idTableName, String in_idField, String in_valueField) throws Exception{
		con=in_con;
		tableName=in_idTableName;
		readIdsTable();
	...
	public int getId(String in_value) throws Exception{
		String value=in_value;
		if(existingIds.containsKey(value)){
			//return existing id
			return existingIds.get(value);
		}
		else if(newIds.containsKey(value)){
			return newIds.get(value);
		}
		else{
			//generate new id
			int newId=++maxId;
